...
table.insert(content, {
	...
	["Name"] = "draw";
	["Arguments"] = {};
	["Description"] = "Draws the object on screen. This is called automatically by the UI system each frame. The given image is stretched such that is fully covers the element's Size.";
})
