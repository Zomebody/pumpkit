...
table.insert(content, {
	["Type"] = "IntroHeader";
	["Name"] = meta.Name;
	["Description"] = "A rectangular container that acts as the base class of any UI object. A Frame can hold other UI objects to create a UI hierarchy, but it can also be used as a label with text, a button, and more.";
...
table.insert(content, {
	...
	["ValueType"] = "string";
	["Name"] = "Class";
	["Description"] = "The class of the UI element. In this case it will be ui_base.";
	["ReadOnly"] = true;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["ValueType"] = "vector";
	["Name"] = "ContentOffset";
	["Description"] = "A vector that indicates an offset in pixels for child elements. You can edit this property with ui_base:shiftContent(x,y). This property is useful to implement scrolling frames or minimaps.";
	["ReadOnly"] = true;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["ValueType"] = "color";
	["Name"] = "Color";
	["Description"] = "The background color of the ui_base.";
	["ReadOnly"] = false;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["ValueType"] = "color";
	["Name"] = "ColorHold";
	["Description"] = "The background color of the ui_base when the element is currently being held down by a mouse click.";
	["ReadOnly"] = false;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["ValueType"] = "color";
	["Name"] = "ColorHover";
	["Description"] = "The background color of the ui_base when the mouse is hovering over the element. This can be used to indicate that you may click on the element, like buttons.";
	["ReadOnly"] = false;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["Demo"] = function()
		...
		LargeSpeech:setText("Bird Seed.ttf", {{0, 0, 0}, "Speech"}, 12)
		...
		SmallSpeech:setText("Bird Seed.ttf", {{0, 0, 0}, "Speech"}, 12)
...
table.insert(content, {
	...
	["ValueType"] = "number";
	["Name"] = "PaddingX";
	["Description"] = "Adds a padding on the left and right side of the ui_base in pixels. This property applies to child elements and the ui_base's TextBlock. This value can be changed with :setPadding().";
	["ReadOnly"] = true;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["ValueType"] = "number";
	["Name"] = "PaddingY";
	["Description"] = "Adds a padding on the top and bottom side of the ui_base in pixels. This property applies to child elements and the ui_base's TextBlock. This value can be changed with :setPadding().";
	["ReadOnly"] = true;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["ValueType"] = "Object";
	["Name"] = "Parent";
	["Description"] = "The parent element of the ui_base. This can be another element or the UI system itself (meaning the element is a top-level element). The parent is automatically set when :addChild() is called on an element and this object is passed as the argument.";
	["ReadOnly"] = true;
	["CodeMarkup"] = nil;
	["Demo"] = nil;
})
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Elem = ui.<f>newFrame</f>(<n>40</n>, <n>40</n>, <f>color</f>(<n>1</n>, <n>1</n>, <n>1</n>))\nContainer:<f>addChild</f>(Elem)\nElem:<f>alignX</f>(<s>\"right\"</s>)";
	["Demo"] = function()
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Frame = ui.<f>newFrame</f>(<n>250</n>, <n>80</n>, <f>color</f>(<n>0</n>, <n>0</n>, <n>0</n>))\nFrame:<f>setPadding</f>(<n>4</n>)\nFrame:<f>setText</f>(<s>\"Roundabout.ttf\"</s>, <s>\"Hello World\"</s>, <n>8</n>)\nFrame:<f>fitText</f>()";
	["Demo"] = function()
		local Frame = ui.newFrame(250, 80, color(0, 0, 0))
		Frame:setPadding(4)
		Frame:setText("Roundabout.ttf", "Hello World", 8)
		Frame:fitText()
		return Frame
	end
})
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Frame1 = ui.<f>newFrame</f>(<n>100</n>, <n>100</n>, <f>color</f>(<n>0</n>, <n>0</n>, <n>0</n>))\nFrame1:<f>setText</f>(<s>\"Roundabout.ttf\"</s>, <s>\"Frame 1\"</s>, <n>18</n>)\n<k>local</k> Frame2 = ui.<f>newFrame</f>(<n>100</n>, <n>100</n>, <f>color</f>(<n>0</n>, <n>0</n>, <n>0</n>))\nFrame2:<f>setText</f>(<s>\"Roundabout.ttf\"</s>, <s>\"Frame 2\"</s>, <n>18</n>)\nFrame2:<f>resize</f>(<n>130</n>, <n>80</n>)";
	["Demo"] = function() -- function that creates and returns an element to be placed right below the code example
		local Container = ui.newFrame(300, 100)
		Container.Opacity = 0
		local Frame1 = ui.newFrame(100, 100, color(0, 0, 0))
		Frame1:setText("Roundabout.ttf", "Frame 1", 18)
		local Frame2 = ui.newFrame(100, 100, color(0, 0, 0))
		Frame2:setText("Roundabout.ttf", "Frame 2", 18)
		Frame2:putNextTo(Frame1, "right", 20)
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Frame1 = ui.<f>newFrame</f>(<n>100</n>, <n>100</n>, <f>color</f>(<n>1</n>, <n>1</n>, <n>1</n>))\nFrame1:<f>setBorder</f>(<f>color</f>(<n>0.4</n>, <n>0.4</n>, <n>1</n>), <n>5</n>)\n<k>local</k> Frame2 = ui.<f>newFrame</f>(<n>100</n>, <n>100</n>, <f>color</f>(<n>1</n>, <n>1</n>, <n>1</n>))\nFrame2:<f>setBorder</f>(<n>10</n>)";
	["Demo"] = function()
		local Container = ui.newFrame(300, 100)
		Container.Opacity = 0
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Container = ui.<f>newFrame</f>(<n>300</n>, <n>100</n>, <f>color</f>(<n>0</n>, <n>0</n>, <n>0</n>))\nContainer:<f>setPadding</f>(<n>20</n>, <n>10</n>)\nContainer:<f>setText</f>(<s>\"Roundabout.ttf\"</s>, <s>\"Hello World\"</s>, <n>18</n>)\n<k>local</k> Child = ui.<f>newFrame</f>(<n>60</n>, <n>60</n>, <f>color</f>(<n>1</n>, <n>1</n>, <n>1</n>))\nChild:<f>alignX</f>(<s>\"right\"</s>)\nChild:<f>alignY</f>(<s>\"bottom\"</s>)\nContainer:<f>addChild</f>(Child)";
	["Demo"] = function()
		local Container = ui.newFrame(300, 100, color(0, 0, 0))
		Container:setPadding(20, 10)
		Container:setText("Roundabout.ttf", "Hello World", 18)
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Frame = ui.<f>newFrame</f>(<n>300</n>, <n>100</n>, <f>color</f>(<n>0</n>, <n>0</n>, <n>0</n>))\nFrame:<f>setText</f>(<s>\"Roundabout.ttf\"</s>, <s>\"The quick brown fox jumps over the lazy dog\"</s>, <n>32</n>, <b>true</b>)";
	["Demo"] = function()
		local Frame = ui.newFrame(300, 100, color(0, 0, 0))
		Frame:setText("Roundabout.ttf", "The quick brown fox jumps over the lazy dog", 32, true)
		return Frame
	end
})
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Frame = ui.<f>newFrame</f>(<n>80</n>, <n>40</n>, <f>color</f>(<n>0</n>, <n>0</n>, <n>0</n>))\n<k>local</k> counter = <n>0</n>\nFrame.OnHoverStart = <f>function</f>()\n\tcounter = counter + <n>1</n>\n\tFrame:<f>setText</f>(<s>\"Roundabout.ttf\"</s>, <f>tostring</f>(counter), <n>18</n>)\n<k>end</k>";
	["Demo"] = function() -- function that creates and returns an element to be placed right below the code example
		local Frame = ui.newFrame(80, 40, color(0, 0, 0))
		local counter = 0
...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> Frame = ui.<f>newFrame</f>(<n>80</n>, <n>40</n>, <f>color</f>(<n>0</n>, <n>0</n>, <n>0</n>))\n<k>local</k> FrameCover = ui.<f>newFrame</f>(<n>80</n>, <n>40</n>, <f>color</f>(<n>1</n>, <n>1</n>, <n>1</n>, <n>0</n>))\nFrame:<f>addChild</f>(FrameCover) <c>-- cover the Frame's OnScroll callback</c>\n<k>local</k> counter = <n>0</n>\nFrame.OnNestedScroll = <f>function</f>()\n\tcounter = counter + <n>1</n>\n\tFrame:<f>setText</f>(<s>\"Roundabout.ttf\"</s>, <f>tostring</f>(counter), <n>18</n>)\n<k>end</k>";
	["Demo"] = function() -- function that creates and returns an element to be placed right below the code example
		local Frame = ui.newFrame(80, 40, color(0, 0, 0))
