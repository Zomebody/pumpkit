...
table.insert(content, {
	["Type"] = "IntroHeader";
	["Name"] = "The Mesh3Group instance";
	["Description"] = "A Mesh3Group is an instanced version of Mesh3. These objects are static and have fewer options but have the benefit of winning a lot of performance by being drawn in only 1 call. Using semi-transparent images with mesh3group objects is discouraged due to mesh sorting limitations unless all pixels are fully opaque or fully transparent but may still have atrefacts. Mesh3Group objects clip alpha very harshly.";
})
