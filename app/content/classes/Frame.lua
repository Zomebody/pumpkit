...
table.insert(content, {
	...
	["CodeMarkup"] = "<k>local</k> frame <k>=</k> ui.<f>newFrame</f>(<n>170</n>, <n>50</n>, <f>color</f>(<n>0.6</n>, <n>0.6</n>, <n>0.6</n>))\nframe:<f>setBorder</f>(<n>3</n>)\nframe.BorderColor <k>=</k> <f>color</f>(<n>0.4</n>, <n>0.4</n>, <n>0.4)</n>\nframe:<f>setText</f>(<s>\"FiraCode.ttf\"</s>, <s>\"An example frame\"</s>, <n>20</n>)\nframe.TextBlock:<f>alignX</f>(<s>\"center\"</s>)\nframe.TextBlock:<f>alignY</f>(<s>\"center\"</s>)";
	["Demo"] = function() -- function that creates and returns an element to be placed right below the code example
		...
		frame:setText("FiraCode.ttf", "An example frame", 18)
